...
public class IMobileSdkAdsUnityPlugin : MonoBehaviour {
	...
	[DllImport("__Internal")]
	private static extern int getFilterMode_(string spotid);
	...
	/// </summary>
	/// <param name="spotid">スポットID</param>
	public static FilterMode getFilterMode(string spotid) {
		#if UNITY_IPHONE
		if(Application.platform == RuntimePlatform.IPhonePlayer) {
			return (FilterMode)getFilterMode_(spotid);
		}
		#endif
